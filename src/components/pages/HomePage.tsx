  ...
  return (
    <div className="min-h-screen bg-background font-paragraph text-foreground overflow-x-clip selection:bg-primary selection:text-primary-foreground">
      ...
      <main className="w-full">
        ...
        <section className="w-full py-24 md:py-32 bg-background relative overflow-hidden pt-24 px-6 md:px-12">
          <div className="max-w-[120rem] mx-auto">
            <h2 className="font-heading text-4xl md:text-6xl font-bold text-primary text-center mb-16 md:mb-20 leading-tight">
              ...
              >
                {[...Array(2)].map((_, setIndex) => (
                  <React.Fragment key={setIndex}>
                    <div className="flex-shrink-0 w-40 h-24 bg-white rounded-lg flex items-center justify-center shadow-lg border border-primary/10 p-4 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                      <Image
                        src="https://static.wixstatic.com/media/e51c33_73528de7d02143fea0538fcb959ee643~mv2.jpeg"
                        alt="Partner Logo 1"
                    ...
                    <div className="flex-shrink-0 w-40 h-24 bg-white rounded-lg flex items-center justify-center shadow-lg border border-primary/10 p-4 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                      <Image
                        src="https://static.wixstatic.com/media/e51c33_a0ef5605593c47b3bdaf21b10c4c708a~mv2.jpeg"
                        alt="Partner Logo 2"
                        className="w-full h-full object-contain filter grayscale hover:grayscale-0 transition-all duration-300"
                        width={160}
                      />
                    ...
                    <div className="flex-shrink-0 w-40 h-24 bg-white rounded-lg flex items-center justify-center shadow-lg border border-primary/10 p-4 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                      <Image
                        src="https://static.wixstatic.com/media/e51c33_492f95fd222e4bb28d177adcfcf5d7e6~mv2.jpeg"
                        alt="Partner Logo 3"
                        className="w-full h-full object-contain filter grayscale hover:grayscale-0 transition-all duration-300"
                        width={160}
                      />
                    ...
                    <div className="flex-shrink-0 w-40 h-24 bg-white rounded-lg flex items-center justify-center shadow-lg border border-primary/10 p-4 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                      <Image
                        src="https://static.wixstatic.com/media/e51c33_eaf4d2b498bf4f19b0ca33260226c85e~mv2.png"
                        alt="Partner Logo 4"
                        className="w-full h-full object-contain filter grayscale hover:grayscale-0 transition-all duration-300"
                        width={160}
                      />
                    ...
                    <div className="flex-shrink-0 w-40 h-24 bg-white rounded-lg flex items-center justify-center shadow-lg border border-primary/10 p-4 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                      <Image
                        src="https://static.wixstatic.com/media/e51c33_88beefb2a8f24fafb8ebe8f8809c7d8c~mv2.png"
                        alt="Partner Logo 5"
                        className="w-full h-full object-contain filter grayscale hover:grayscale-0 transition-all duration-300"
                        width={160}
                      />
                    ...
                    <div className="flex-shrink-0 w-40 h-24 bg-white rounded-lg flex items-center justify-center shadow-lg border border-primary/10 p-4 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                      <Image
                        src="https://static.wixstatic.com/media/e51c33_5112a5c623464ea19554e34fffcbb6db~mv2.png"
                        alt="Partner Logo 6"
                        className="w-full h-full object-contain filter grayscale hover:grayscale-0 transition-all duration-300"
                        width={160}
                      />
                    ...
                    <div className="flex-shrink-0 w-40 h-24 bg-white rounded-lg flex items-center justify-center shadow-lg border border-primary/10 p-4 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                      <Image
                        src="https://static.wixstatic.com/media/e51c33_05dcd5ad1bb5447497a08101d9366909~mv2.jpeg"
                        alt="Partner Logo 7"
                        className="w-full h-full object-contain filter grayscale hover:grayscale-0 transition-all duration-300"
                        width={160}
                      />
